...
/**
 * check_validity - checks if the number only contains 0's and 1's
 * @str: the string to check
 *
 * Return: returns length of string if valid, 0 if not
 */
unsigned int check_validity(char *str)
{
	unsigned int len = 0;
...
/**
 * convert_binary - converts the string from binary to int
 * @str: the string to convert
 * @index: the highest index
 *
 * Return: the converted number
 */
unsigned int convert_binary(char *str, unsigned int index)
{
